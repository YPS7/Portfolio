...
export default function Hero() {
  const titles = ["an A.I Engineer", "a Software Engineer", "a Full-Stack Developer"];
    ...
    >
      <div className="text sm:w-[60%]">
        ...
        >
          ...
          <span className="bg-gradient-to-br bg-clip-text text-transparent from-[#5D5D5D] via-[#7F7F7F] to-[#AAAAAA]">
  Yash Pratap Singh
</span>
          <p>
        ...
        >
          I don’t just turn ideas into products, I build solutions with purposeful precision.
        </motion.p>
      </div>
